...
export const REGISTRIES = [
  ...
  },
  {
    ...
    knownMarksKey: 'uspto',
    requiresKey:   false,
    note:          'TSDR API — fetch by serial number; USPTO_API_KEY recommended (free)',
  },
  {
    id:            'ipindia',
    label:         'IP India',
    ...
    csvColumns:    ['Applicant', 'Application Number', 'Mark Name', 'Class', 'Filed Date', 'Status', 'Valid Until'],
  },
  {
    id:            'ilpo',
    label:         'ILPO Israel',
